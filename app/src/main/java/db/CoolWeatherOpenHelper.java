...
public class CoolWeatherOpenHelper extends SQLiteOpenHelper {
    ...
    public static final String CREATE_COUNTRY = "create table Country(_id integer primary key autoincrement,country_name text,country_code text,city_id integer)";
